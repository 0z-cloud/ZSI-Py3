...
import sys, urllib.parse, warnings
from ZSI.wstools import WSDLTools
from ZSI.ServiceContainer import ServiceSOAPBinding, WSAResource
...
from ZSI.generate.containers import BindingDescription
from ZSI.generate.wsdl2python import MessageWriter, WriteServiceModule
...
class ServiceModuleWriter:
    ...
    def setUpInitDef(self, service):
        ...
        if sd.location is not None:
            _,_,path,_,_,_ = urllib.parse.urlparse(sd.location)
    ...
    def write(self, fd=sys.stdout):
        ...
        for v in list(self._services.values()):
